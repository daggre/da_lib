...
dat.flags.ik = {
    ...
    { value = (1 << 10), name = "AIK_USE_FP_ARM_LEFT", note = "First Person Left Arm" },  -- Makes arm invis in first-person
    { value = (1 << 11), name = "AIK_USE_FP_ARM_RIGHT", note = "First Person Right Arm" }, -- Makes arm invis in first-person
    ...
    { value = (1 << 27), name = "AIK_0x5B5D2BEF", note = "" }, -- Works like AIK_UPPERBODY
