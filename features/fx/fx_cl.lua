...
local LoadPtfxDict = function(ptfxDict)
    ...
    log.debug("Requesting Asset ptfxDict", ptfxDictHash)
    RequestNamedPtfxAsset(ptfxDictHash)
    local timeout = GetGameTimer() + 1000
    while not HasNamedPtfxAssetLoaded(ptfxDictHash) do
        if GetGameTimer() > timeout then
            log.debug("Failed to load ptfxDict", ptfxDictHash)
            return false
        end
        Citizen.Wait(100)
    end
...
local StartParticleFxLoopedOnPedBone = function(ptfxName, entity, boneIndex, xOff, yOff, zOff, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis)
...
local StartParticleFxLoopedOnEntityBone = function(ptfxName, entity, boneIndex, xOff, yOff, zOff, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis)
    return Citizen.InvokeNative(0xD3BA6EC7F2FBD5E9, ptfxName, entity, xOff, yOff, zOff, xRot, yRot, zRot, boneIndex, scale, xAxis, yAxis, zAxis, false)
end
...
local StartNetParticleFxLoopedOnBone = function(ptfxName, entity, boneIndex, xOffset, yOffset, zOffset, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis)
    return Citizen.InvokeNative(0x9C56621462FFE7A6, ptfxName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex, scale, xAxis, yAxis, zAxis)
end
    ...
    if options.networked then
        ...
        if options.entity then
            ...
            if options.bone then
                ...
                if options.loop then
                    ...
                    log.debug("Starting looped net ptfx on bone")
                    ...
                    log.error("Networked ptfx non-looped on bone is not supported")
                    -- log.debug("Starting ptfx on bone")
                ...
                if options.loop then
                    ...
                    log.debug("Starting looped net ptfx on entity")
                    ...
                    log.debug("Starting net ptfx on entity")
        ...
        elseif options.coords then
            ...
            if options.loop then
                ...
                log.error("Networked looped net ptfx at location is not supported")
                -- log.debug("Starting looped ptfx at location", ptfxName, coords.x, coords.y, coords.z, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis)
                ...
                log.debug("Starting net ptfx at location", options)
        ...
        if options.entity then
            ...
            if options.bone then
                ...
                if options.loop then
                    ...
                    log.debug("Starting looped ptfx on entity/ped bone")
                    -- return StartParticleFxLoopedOnPedBone(ptfxName, options.entity, boneIndex, xOff, yOff, zOff, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis)
                    return StartParticleFxLoopedOnEntityBone(ptfxName, options.entity, boneIndex, xOff, yOff, zOff, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis)
                else
                ...
                if options.loop then
                    ...
                    log.debug("Starting looped ptfx on entity")
                    ...
                    log.debug("Starting ptfx on entity")
        ...
        elseif options.coords then
            ...
            if options.loop then
                ...
                log.debug("Starting ptfx at location", options)
...
Fx.new = function(ptfxDict, ptfxName, options)
