...
dat.keyHash = {
    ...
    ['MouseX'] = `INPUT_CURSOR_X`,
    ['MouseY'] = `INPUT_CURSOR_Y`,
    ['HorseGunLR'] = `INPUT_HORSE_GUN_LR`,
    ['HorseGunUD'] = `INPUT_HORSE_GUN_UD`,
    -- ['LookRight'] = `INPUT_LOOK_RIGHT_ONLY`,
    -- ['LookLeft'] = `INPUT_MOVE_LEFT_ONLY`,
    -- ['CinemaLR'] = `INPUT_CINEMATIC_CAM_LR`,
    -- ['CinemaUD'] = `INPUT_CINEMATIC_CAM_UD`,
    -- ['RadialLR'] = `INPUT_RADIAL_MENU_NAV_LR`,
    -- ['RadialUD'] = `INPUT_RADIAL_MENU_NAV_UD`,
    ...
    ['LeftBracket'] = `INPUT_SNIPER_ZOOM_OUT_ONLY`,
